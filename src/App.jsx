  ...
  return (
    ...
    <div className='hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1'>
      <div className='animate__animated animate__fadeInUp animate__delay-2s'>
        ...
        <p>Kode yang indah terlahir dari pikiran yang kreatif, Iziinn 🙏</p>
        </div>
        <h1 className='text-5xl/tight mb-6'>Hi, Saya Rae Triadi</h1>
        <p className='text-base/loose mb-6 opacity-50'>Saya mempunyai ketertarikan dalam bidang programming yang berfokus pada pembuatan aplikasi web yang menarik dan fungsional.</p>
      <div className='flex items-center sm:gap-4 gap-2'>
        <a href="" className='bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600'>Download CV <i className="ri-download-line ri-lg"></i></a>
        <a href="" className='border border-blue-500 text-blue-500 px-4 py-2 rounded-md hover:bg-blue-500 hover:text-white'>Lihat Proyek <i className="ri-arrow-down-line ri-lg"></i></a>
      </div>
      </div>
      <img src={DataImage.HeroImage} alt="Hero Image"className='w-[500px] rounded-2xl md:ml-auto animate__animated animate__fadeInUp animate__delay-3s'loading='lazy'/>
    </div>

    {/* Tentang */}
    <div className='tentang mt-32 py-10'>
      <div className='xl:w-2/3 lg:w-full mx-auto p-7 bg-zinc-800 rounded-lg' 
    ...
    <p className='xl:w-2/5 lg:w-2/4 md:w-2/3 sm:w-3/4 w-full base/loose opacity-50' data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">Berikut adalah beberapa tools yang saya gunakan dalam pengembangan aplikasi web.</p>
    ...
    <div className="proyek mt-32 py-10">
      ...
      <p className='text-base text-center opacity-50' data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">Berikut adalah beberapa proyek yang telah saya kerjakan.</p>
...
<div className="contact mt-32 sm:p-10 p-0">
  ...
  <form
    action=" https://formsubmit.co/jkotriady@gmail.com" method='POST'
  ...
  >
    <div className="flex flex-col gap-6">
      ...
      <div className="text-center">
        <button
          type="submit"
          className="bg-blue-500 p-3 rounded-lg w-full cursor-pointer block border border-zinc-600"
        >
          Kirim Pesan
        </button>
      </div>
